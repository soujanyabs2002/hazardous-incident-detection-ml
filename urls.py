"""unsupervised_machine_learning URL Configuration
...
from Detecting_and_Managing_Railway import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Accident_Type/$', remoteuser.Predict_Accident_Type, name="Predict_Accident_Type"),
    ...
    url(r'^View_Predicted_Accident_Type_Ratio/$', serviceprovider.View_Predicted_Accident_Type_Ratio, name="View_Predicted_Accident_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Predicted_Accident_Type_Details/$', serviceprovider.View_Predicted_Accident_Type_Details, name="View_Predicted_Accident_Type_Details"),
