...
--
-- Database: `unsupervised_machine_learning`
--
CREATE DATABASE IF NOT EXISTS `Detecting_and_Managing_Railway` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `Detecting_and_Managing_Railway`;
...
('evt5fof8q0e8dynatbxpf51gkldwrnpk', 'eyJ1c2VyaWQiOjJ9:1rUmVc:uvIfJgDC-j6KJKiskWI45SO7KbLkLDniZKjGygELa-A', '2024-02-13 11:42:32.140160'),
...
('ixv4p127v3guwkvr0tfnfoseg95tu1zx', 'eyJ1c2VyaWQiOjF9:1rUkzC:ZizbXO6UvCQ3mI6qc4PaQHMdD-6FFrPbkRCvrEKH42k', '2024-02-13 10:04:58.642800'),
...
--
-- Table structure for table `remote_user_accident_type_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_accident_type_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `RID` varchar(3000) NOT NULL,
  `Location` varchar(3000) NOT NULL,
  `Latitude` varchar(3000) NOT NULL,
  `Longitude` varchar(3000) NOT NULL,
  `Avgpassengersperday` varchar(3000) NOT NULL,
  `Nooftrainspassing` varchar(3000) NOT NULL,
  `Nooftrainsstopping` varchar(3000) NOT NULL,
  `Noofplatforms` varchar(3000) NOT NULL,
  `Nooftracks` varchar(3000) NOT NULL,
  `Trainhaltingtime` varchar(3000) NOT NULL,
  `Avgtrainspeed` varchar(3000) NOT NULL,
  `Averageaccidentspermonth` varchar(3000) NOT NULL,
  `population` varchar(3000) NOT NULL,
  `PhysicalEnvironment` varchar(3000) NOT NULL,
  `DateTime` varchar(3000) NOT NULL,
  `admin_found` varchar(3000) NOT NULL,
  `Prediction` varchar(3000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;

--
-- Dumping data for table `remote_user_accident_type_prediction`
--

INSERT INTO `remote_user_accident_type_prediction` (`id`, `RID`, `Location`, `Latitude`, `Longitude`, `Avgpassengersperday`, `Nooftrainspassing`, `Nooftrainsstopping`, `Noofplatforms`, `Nooftracks`, `Trainhaltingtime`, `Avgtrainspeed`, `Averageaccidentspermonth`, `population`, `PhysicalEnvironment`, `DateTime`, `admin_found`, `Prediction`) VALUES
(1, '10.42.0.42-54.239.26.255-33591-443-6', 'Weifang', '36.7167', '119.1', '9999', '68', '12', '10', '7', '10', '1.6', '96', '9373000', 'Pedestrain', '02-11-22 9:29', 'Evening', 'No Safety Accident'),
(2, '10.42.0.211-52.84.143.39-58310-80-6', 'Fuyang', '32.8986', '115.8045', '952', '78', '9', '2', '5', '4', '1.2', '19', '8360000', 'Lineside', '02-11-22 9:59', 'Evening', 'Safety Accident'),
(3, '10.42.0.211-23.21.95.195-56360-443-6', 'Suining', '30.5098', '105.5737', '7850', '80', '45', '5', '4', '3', '1.8', '1', '3556000', 'Road', '03-11-22 15:19', 'Evening', 'Safety Accident');
...
(1, 'Gopinath', 'Gopinath123@gmail.com', 'Gopinath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#809,4th Cross,Rajajinagar', 'Male'),
...
(19, 'KNeighborsClassifier', '47.69736842105263'),
(20, 'Decision Tree Classifier', '45.06578947368421'),
(21, 'Naive Bayes', '46.05263157894737'),
(22, 'SVM', '42.76315789473684'),
(23, 'Logistic Regression', '44.07894736842105'),
(24, 'Gradient Boosting Classifier', '43.42105263157895');
...
(8, 'No Safety Accident', '33.33333333333333'),
(9, 'Safety Accident', '66.66666666666666');
